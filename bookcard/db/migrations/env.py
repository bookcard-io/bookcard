...
from bookcard.models.conversion import BookConversion
...
# (bookcard/db/migrations/env.py -> bookcard/db/migrations -> bookcard/db -> moose -> project root)
load_dotenv()
...
# These tables are defined in bookcard/models/core.py, media.py, reading.py, and system.py
EXCLUDED_TABLES = {
    # From core.py
    "authors",
    "publishers",
...
def include_object(
    ...
    Excludes all tables from bookcard/models/core.py, media.py, reading.py,
