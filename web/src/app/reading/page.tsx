...
/**
 * Reading history page content.
 *
 * Displays reading history with tabs for Recent Reads, All Sessions, and Reading Stats.
 * This component is rendered inside PageLayout, so it has access to ActiveLibraryProvider context.
        ...
        {activeTab === "sessions" && (
          <div>
            ...
            {!isLoading && !error && sessions.length === 0 && (
              <div className="flex items-center justify-center p-8">
                <span className="text-text-a40">No reading sessions yet.</span>
              </div>
            )}
            {!isLoading && !error && sessions.length > 0 && (
 ...
 *
 * Wraps the content with PageLayout to provide necessary context providers.
 */
