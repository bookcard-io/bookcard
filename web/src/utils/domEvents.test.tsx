...
import { isEditableEventTarget } from "./domEvents";

describe("isEditableEventTarget", () => {
  it("returns false for null/non-HTMLElement targets", () => {
  ...
  it("returns false for non-editable elements", () => {
    ...
    expect(isEditableEventTarget(document.createElement("span"))).toBe(false);
  });
});
