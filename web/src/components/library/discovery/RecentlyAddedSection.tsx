 ...
 *
 * Displays books sorted by creation date (timestamp), infinitely scrolled horizontally.
 * Follows SRP by focusing solely on recently added books display.
 */
export function RecentlyAddedSection({
  ...
  // Flatten books from infinite query pages
