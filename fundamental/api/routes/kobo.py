...
from fundamental.api.schemas.kobo import (
...
from fundamental.repositories.reading_repository import ReadStatusRepository
...
from fundamental.services.kobo.download_service import KoboDownloadService
from fundamental.services.kobo.initialization_service import KoboInitializationService
...
def handle_tags_update(
    ...
    if request.method == "DELETE":
        from fundamental.repositories.shelf_repository import BookShelfLinkRepository
        from fundamental.services.shelf_service import ShelfService
