...
from fundamental.services.calibre_plugin_service.exceptions import PluginSourceError

if TYPE_CHECKING:
    from collections.abc import Iterator
    from pathlib import Path

    from fundamental.services.calibre_plugin_service.commands import CommandExecutor
